...
function ZCodeEmptyStateLogo({ className }: { className?: string }) {
  return (
    <>
      {/* 单一 Lumi 折叠 L 线框水印：Lumi 只有浅色主题，不再保留上游“深色专用渐变资源”的第二套 Logo。 */}
      <svg
        aria-hidden="true"
        className={cn(
          className,
      ...
      >
        {/* 折叠 L 几何（brand/lumi-mark.svg）：竖直平面 + 水平平面由 45° 通道分开。 */}
        <g transform="translate(56 48) scale(1.15)">
          <path d="M56 32H120V160L56 224Z" stroke="currentColor" strokeWidth="2" fill="none" />
          <path
            d="M120 176L128 168H232V232H64Z"
            stroke="currentColor"
            strokeWidth="2"
            fill="none"
          />
